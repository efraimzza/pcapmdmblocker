...
public class activityadbpair extends Activity {
    ...
    private Button bupair,bucon,buconmult,budisacccon,buenacccon,budisaccmult,buenaccmult,bucheckaccmult,bugrantsecmult,budisacc,buenacc,buexecall;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bugrantsecmult = findViewById(R.id.bugrantsecmult);
            ...
            public void onCommandFinished(final int exitCode, final String finalOutput, final String finalError) {
                runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            bugrantsecmult.setEnabled(true);
